...
const MIGRATIONS: Migration[] = [
  ...
  { version: 22, sql: `CREATE INDEX IF NOT EXISTS idx_rss_feeds_chat_id ON rss_feeds(chat_id)` },
  {
    version: 23,
    sql: `ALTER TABLE rss_feeds ADD COLUMN failure_count INTEGER NOT NULL DEFAULT 0`,
  },
];
